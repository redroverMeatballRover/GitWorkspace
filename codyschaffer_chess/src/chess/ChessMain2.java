...
class ChessMain2 {
	...
	public static void doChess() throws NumberFormatException, IOException {
		...
		// renema
		pieces[7][1] = new Pawn("Bpn1");
		pieces[7][2] = new Pawn("Bpn2");
		pieces[7][3] = new Pawn("Bpn3");
		pieces[7][4] = new Pawn("Bpn4");
		pieces[7][5] = new Pawn("Bpn5");
		pieces[7][6] = new Pawn("Bpn6");
		pieces[7][7] = new Pawn("Bpn7");
		pieces[7][8] = new Pawn("Bpn8");
		
		pieces[8][1] = new Rook("BR1");
		pieces[8][2] = new Knight("BN1");
		pieces[8][3] = new Bishop("BB1");
		pieces[8][5] = new King("KingD");
		pieces[8][4] = new Queen("BQueen");
		pieces[8][6] = new Bishop("BB2");
		pieces[8][7] = new Knight("BN2");
		pieces[8][8] = new Rook("BR2");
		
		pieces[2][1] = new Pawn("Wpn1");
		pieces[2][2] = new Pawn("Wpn2");
		pieces[2][3] = new Pawn("Wpn3");
		pieces[2][4] = new Pawn("Wpn4");
		pieces[2][5] = new Pawn("Wpn5");
		pieces[2][6] = new Pawn("Wpn6");
		pieces[2][7] = new Pawn("Wpn7");
		pieces[2][8] = new Pawn("Wpn8");
		
		pieces[1][1] = new Rook("WR1");
		pieces[1][2] = new Knight("WN1");
		pieces[1][3] = new Bishop("WB1");
		pieces[1][4] = new King("KingL");
		pieces[1][5] = new Queen("WQueen");
		pieces[1][6] = new Bishop("WB2");
		pieces[1][7] = new Knight("WN2");
		pieces[1][8] = new Rook("WR2");
...
//			 }
			...
			if (pieces[row1st][colStart] != null //pieces[row1st][colStart] ====== use this to debug, as well as put in the expressions in order to check for the black/whites *USE THIS*
