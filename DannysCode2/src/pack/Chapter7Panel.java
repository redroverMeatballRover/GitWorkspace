...
public class Chapter7Panel extends JPanel 
{
	...
	private class Listener1 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter7Section1Panel panel = new Chapter7Section1Panel();
	...
	private class Listener2 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter7Section2Panel panel = new Chapter7Section2Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener3 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter7Section3Panel panel = new Chapter7Section3Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener4 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter7Section4Panel panel = new Chapter7Section4Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener5 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter7Section5Panel panel = new Chapter7Section5Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener6 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter7Section6Panel panel = new Chapter7Section6Panel();
			frame.getContentPane().add(panel);
