 ...
 *
 */
public class Chapter3Panel extends JPanel 
{
	/**
	 * 
	 */
	...
	private class Listener1 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter3Section1Panel panel = new Chapter3Section1Panel();
	...
	private class Listener2 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter3Section2Panel panel = new Chapter3Section2Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener3 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter3Section3Panel panel = new Chapter3Section3Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener4 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter3Section4Panel panel = new Chapter3Section4Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener5 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter3Section5Panel panel = new Chapter3Section5Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener6 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter3Section6Panel panel = new Chapter3Section6Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener7 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter3Section7Panel panel = new Chapter3Section7Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener8 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter3Section8Panel panel = new Chapter3Section8Panel();
			frame.getContentPane().add(panel);
