...
public class chess10 extends java.applet.Applet implements MouseMotionListener
{
	...
	class MousePressListener extends MouseAdapter
	{
		...
		public void BoardID(int x, int y)
		{
			...
			//System.out.println("y/50 = " + y/50 + ", x/50 = " + x/50);
			System.out.println("you clicked " + y/50 + ", " + x/50);
			for (int i = 0; i < 32; i++)
			{
				if (((y / 50) + 1 == pieces[i].row) && ((x / 50) + 1 == pieces[i].column))
				{
					...
					System.out.println("Piece ID = " + pieces[i].IDNum);
				}
			}
		}
	}
