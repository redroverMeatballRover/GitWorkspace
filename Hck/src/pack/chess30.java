...
public class chess30 extends java.applet.Applet implements MouseMotionListener
{
	...
	class MousePressListener extends MouseAdapter
	{
		...
		public boolean CheckMethod()
		{
			...
			if (checked)
			{
				System.out.println("Piece index = " + pieces[pieceChosen].IDNum);
				System.out.println("Piece name = " + pieces[pieceChosen].name);
				System.out.println("Piece row = " + pieces[pieceChosen].row);
				System.out.println("Piece col = " + pieces[pieceChosen].column);
			}
			return checked;
		}
		...
		public void RookCheck(int control, int index, int kingnum)
		{
			...
			System.out.println("index = " + index);
			System.out.println("kingnum = " + kingnum);
		}
