...
//there is no chess13, that would be unlucky!
...
public class chess14 extends java.applet.Applet implements MouseMotionListener
{
	...
	class MousePressListener extends MouseAdapter
	{
		...
		public boolean Rules(int y, int x)
		{
		...
		public void MovePiece(int x, int y)
		{
			...
			if (Rules(x,y))
			{
				...
				//inside checks for another piece
				for (int i = 0; i < 32; i++)
				{
					//don't take self
					if (pieceChosen != i)
