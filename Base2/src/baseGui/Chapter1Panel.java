...
public class Chapter1Panel extends JPanel 
{
	...
	private class Listener1 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter1Section1Panel panel = new Chapter1Section1Panel();
	...
	private class Listener2 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter1Section2Panel panel = new Chapter1Section2Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener3 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter1Section3Panel panel = new Chapter1Section3Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener4 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter1Section4Panel panel = new Chapter1Section4Panel();
			frame.getContentPane().add(panel);
	...
	private class Listener5 implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			Chapter1Section5Panel panel = new Chapter1Section5Panel();
			frame.getContentPane().add(panel);
