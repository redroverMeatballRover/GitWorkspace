 ...
 */
public class QuizScore10 extends JPanel  {
...
//	JTextArea area;
	...
	//constructor
	public QuizScore10(int s1, String correct, String incorrect) {
		
		setLayout (new GridLayout(5,5));
		Quiz10 sop = new Quiz10();
	...
	private class ButtonListener implements ActionListener{
		public void actionPerformed (ActionEvent event){
			if (event.getSource() == fail) // THIS IS THE RECURSIVE PART, IT CALLS THE QUIZ AGAIN
			{
				...
				JFrame frame = new JFrame("Quiz 10.1");
