...
public class Chapter7Panel extends JPanel 
{
	...
	public Chapter7Panel()
	{
		...
		study.addTab("Sec 7.1", section1);
		study.addTab("Sec 7.2", section2);
		study.addTab("Sec 7.3", section3);
		study.addTab("sec 7.4", section4);
		study.addTab("Sec 7.5", section5);
	...
	public Chapter7Panel(int x, int y)
	{
		setPreferredSize(new Dimension(1000,800));
		study = new JTabbedPane();
		main = new JPanel();
	...
	public static void section1()
	{
		...
		textArea = new JTextArea(read("text/Section7.1.txt"), 70, 70);
	...
	{
		section2 = new JPanel();
		textArea = new JTextArea(read("text/Section7.2.txt"), 70, 70);
		textArea.setFont(new Font("Serif", Font.LAYOUT_LEFT_TO_RIGHT, 15));
		textArea.setFont(new Font("Serif", Font.BOLD, 15));
		textArea.setBounds(0, 0, 600, 600);
		textArea.setEditable(false);
	...
	{
		section3 = new JPanel();
		textArea = new JTextArea(read("text/Section7.3.txt"), 70, 70);
		textArea.setFont(new Font("Serif", Font.LAYOUT_LEFT_TO_RIGHT, 15));
		textArea.setFont(new Font("Serif", Font.BOLD, 15));
		textArea.setBounds(0, 0, 600, 600);
		textArea.setEditable(false);
	...
	{
		section4 = new JPanel();
		textArea = new JTextArea(read("text/Section7.4.txt"), 70, 70);
		textArea.setFont(new Font("Serif", Font.LAYOUT_LEFT_TO_RIGHT, 15));
		textArea.setFont(new Font("Serif", Font.BOLD, 15));
		textArea.setBounds(0, 0, 600, 600);
		textArea.setEditable(false);
	...
	public static void section5()
	{
		...
		textArea = new JTextArea(read("text/Section7.5.txt"), 70, 70);
		textArea.setFont(new Font("Serif", Font.LAYOUT_LEFT_TO_RIGHT, 15));
		textArea.setFont(new Font("Serif", Font.BOLD, 15));
		textArea.setBounds(0, 0, 600, 600);
		textArea.setEditable(false);
	...
	public static void quiz()
	{
		...
		button.addActionListener(new Listener7());
		quiz.add(button);
	}
}
