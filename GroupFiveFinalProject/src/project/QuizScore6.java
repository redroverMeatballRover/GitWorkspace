 ...
 */
public class QuizScore6 extends JPanel  {
...
//	JTextArea area;
	...
	//constructor
	public QuizScore6(int s1, String correct, String incorrect) {
		...
		fail6 = new JButton ("Retake Quiz");
		success = new JButton ("Move on to the next section");
		
		fail6.addActionListener(new ButtonListener());
...
//		add(area);
	...
	private class ButtonListener implements ActionListener{
		public void actionPerformed (ActionEvent event){
			if (event.getSource() == fail6) // THIS IS THE RECURSIVE PART, IT CALLS THE QUIZ AGAIN
			{
				calculate();
