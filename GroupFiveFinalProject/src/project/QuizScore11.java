 ...
 */
public class QuizScore11 extends JPanel  {
	...
	//constructor
	public QuizScore11(int s1, String correct, String incorrect) {
		
		setLayout (new GridLayout(5,5));
		Quiz11 sop = new Quiz11();
	...
	private class ButtonListener implements ActionListener{
		public void actionPerformed (ActionEvent event){
			...
			{
				calculate();
				JFrame frame = new JFrame("Quiz 11.1");
