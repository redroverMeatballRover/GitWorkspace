...
/**
 * This class creates the chapter 9 portion of the 
 * study guide. 
 */
public class Chapter9Panel extends JPanel 
{
	...
	public Chapter9Panel()
	{
		...
		study.addTab("Sec 9.1", section1);
		study.addTab("Sec 9.2", section2);
		study.addTab("Sec 9.3", section3);
		study.addTab("sec 9.4", section4);
	...
	//constructor
	public Chapter9Panel(int x, int y)
	{
		setPreferredSize(new Dimension(1000,800));
		study = new JTabbedPane();
		main = new JPanel();
	...
	public static void section1()
	{
		...
		textArea = new JTextArea(read("text/ch9sec1.txt"), 70, 70);
	...
	{
		section2 = new JPanel();
		textArea = new JTextArea(read("text/ch9sec2.txt"), 70, 70);
		textArea.setFont(new Font("Serif", Font.LAYOUT_LEFT_TO_RIGHT, 15));
		textArea.setFont(new Font("Serif", Font.BOLD, 15));
		textArea.setBounds(0, 0, 600, 600);
		textArea.setEditable(false);
	...
	{
		section3 = new JPanel();
		textArea = new JTextArea(read("text/ch9sec3.txt"), 70, 70);
		textArea.setFont(new Font("Serif", Font.LAYOUT_LEFT_TO_RIGHT, 15));
		textArea.setFont(new Font("Serif", Font.BOLD, 15));
		textArea.setBounds(0, 0, 600, 600);
		textArea.setEditable(false);
	...
	{
		section4 = new JPanel();
		textArea = new JTextArea(read("text/ch9sec4.txt"), 70, 70);
		textArea.setFont(new Font("Serif", Font.LAYOUT_LEFT_TO_RIGHT, 15));
		textArea.setFont(new Font("Serif", Font.BOLD, 15));
		textArea.setBounds(0, 0, 600, 600);
		textArea.setEditable(false);
	...
	public static void quiz()
	{
		...
		button.addActionListener(new Listener9());
		quiz.add(button);
	}
}
//listens for the take quiz button to run the quiz
	class Listener9 implements ActionListener
	{
		...
		{
			JFrame frame = new JFrame("Quiz Chapter 9: Polymorphism");
			
			frame.getContentPane().add(new Quiz9());
