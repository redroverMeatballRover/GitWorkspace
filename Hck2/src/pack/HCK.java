	...
	public class HCK extends JFrame implements MouseListener
	{
		public static void main(String[] args)
		{
			final HCK ap = new HCK();
		}
		...
		public void mouseClicked(MouseEvent e)
		{
			if (bMyTurn)
			{
				...
				int intX = (pnlTemp.getX() / 57); // QUESTION
				int intY = (pnlTemp.getY() / 57); // QUESTION
				...
				if (this.boolMoveSelection)
				{
					...
					if ((!this.strChessBoard[this.pntMoveFrom.y][this.pntMoveFrom.x].toString().trim().equals(""))&& this.bWhite && this.strChessBoard[this.pntMoveFrom.y][this.pntMoveFrom.x].toString().charAt(1) == 'B')
						this.boolMoveSelection = !this.boolMoveSelection;
					
					if ((!this.strChessBoard[this.pntMoveFrom.y][this.pntMoveFrom.x].toString().trim().equals("")) && !this.bWhite && this.strChessBoard[this.pntMoveFrom.y][this.pntMoveFrom.x].toString().charAt(1) == 'W')
						this.boolMoveSelection = !this.boolMoveSelection;
		...
		private ImageIcon rookBlack = new ImageIcon("chessTest.png");
		private ImageIcon rookWhite = new ImageIcon("chessTest.png");
		private ImageIcon bishopBlack = new ImageIcon("chessTest.png");
		private ImageIcon bishopWhite = new ImageIcon("chessTest.png");
		private ImageIcon knightBlack = new ImageIcon("chessTest.png");
		private ImageIcon knightWhite = new ImageIcon("chessTest.png");
		private ImageIcon kingBlack = new ImageIcon("chessTest.png");
		private ImageIcon kingWhite = new ImageIcon("chessTest.png");
		private ImageIcon queenBlack = new ImageIcon("chessTest.png");
		private ImageIcon queenWhite = new ImageIcon("chessTest.png");
		private ImageIcon pawnBlack = new ImageIcon("chessTest.png");
		private ImageIcon pawnWhite = new ImageIcon("chessTest.png");
